...
Before this step, it is necessary to perform an analysis of the coding potential with external tools, here are some examples of the tools used in this tutorial:
  ...
  - [CPC2](https://github.com/gao-lab/CPC2_standalone/releases/tag/v1.0.1)  -  (https://doi.org/10.1093/nar/gkx428)
- [FEELnc](https://github.com/tderrien/FEELnc)  -  (https://doi.org/10.1093/nar/gkw1306)
- [PLEK](https://sourceforge.net/projects/plek/files/)  -  (https://doi.org/10.1186/1471-2105-15-311)
- [LncFinder](https://github.com/HAN-Siyu/LncFinder)  -  (https://doi.org/10.1093/bib/bby065)
- [CNCI](https://github.com/www-bioinfo-org/CNCI)  -  (https://doi.org/10.1093/nar/gkt646)
- [CPAT](https://cpat.readthedocs.io/en/latest/)  -  (https://doi.org/10.1093/nar/gkt006)
- [lncRNA_Mdeep](https://github.com/NWPU-903PR/lncRNA_Mdeep)  -  (https://doi.org/10.3390/ijms21155222)

and some moretools you can find [here](https://lncfinder.osubmi.org/index.php?m=Home&c=Index&a=information#Prediction).
