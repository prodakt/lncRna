...
Fourfold, Radar and Clock plots provide a holistic view of tool performance across multiple metrics.

```{r viz-performance, fig.width=10, fig.height=6}
# Fourfold plot of tool combinations
plotFourfoldCm(cmList = allCms, plotTitle = "Fourfold tool combination plots")
