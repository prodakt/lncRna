...
#'
#' This function allows you to split a sequences \(from FASTA file\) into two sets: test and train. 
#' As a result, the function outputs a list consisting of two elements "test" and "train" containing sequence names.
#' 
#' @param nc the variable containing sequences in fasta format (from read.fasta() function from seqinr library)
...
#' # nc_tt <- test.train.nc(nc = nc, percent_train = 0.6)
