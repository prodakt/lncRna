...
#' @param selection An optional logical vector indicating which tools to include
#'   (TRUE for include, FALSE for exclude). If `NULL`, all available tools are used.
...
plotVennCodPot <- function(codPot, selection = NULL,
  ...
  selectedToolNames <- names(codPot$tools)[which(selection)]
